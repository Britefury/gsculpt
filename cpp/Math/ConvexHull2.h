...
class GS_DllExport ConvexHull2
{
private:
...
public:
	...
	friend GS_DllExport void operator*=(ConvexHull2 &p, const Matrix4 &m);
	friend GS_DllExport ConvexHull2 operator*(const ConvexHull2 &p, const Matrix4 &m);
};


GS_DllExport void operator*=(ConvexHull2 &p, const Matrix4 &m);
GS_DllExport ConvexHull2 operator*(const ConvexHull2 &p, const Matrix4 &m);
