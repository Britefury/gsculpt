...
##-*************************
from Britefury.CellEdit.StringCellEditAccelEntry import StringCellEditAccelEntry

from Britefury.SheetEdit.SheetEdit import BasicSingleFieldWidgetEditor



class StringFieldEditAccelEntry (BasicSingleFieldWidgetEditor):
	__componentnames__ = [ 'entry' ]

	def createElement(self, sheetEditContext):
		return StringCellEditAccelEntry()
...
if __name__ == '__main__':
	...
	class ExampleEditor (SheetEditor):
		...
		aEdit = StringFieldEditAccelEntry( sheet.a )
