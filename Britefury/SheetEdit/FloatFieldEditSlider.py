...
##-*************************
from Britefury.CellEdit.FloatCellEditSlider import FloatCellEditSlider

from Britefury.SheetEdit.SheetEdit import BasicSingleFieldWidgetEditor



class FloatFieldEditSlider (BasicSingleFieldWidgetEditor):
	__componentnames__ = [ 'slider' ]

	def __init__(self, field, minValue, maxValue, step, page):
		super( FloatFieldEditSlider, self ).__init__( field )
	...
	def createElement(self, sheetEditContext):
		return FloatCellEditSlider( self._minValue, self._maxValue, self._step, self._page )
...
if __name__ == '__main__':
	...
	class ExampleEditor (SheetEditor):
		...
		aEdit = FloatFieldEditSlider( sheet.a, -1024.0, 1024.0, 1.0, 10.0 )

		layout = FormLayoutFactory()
		layout.row()  <<  aLabel.label << aEdit.slider
		layout.row()
		layout.finalise()
