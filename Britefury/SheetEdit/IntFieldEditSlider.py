...
##-*************************
from Britefury.CellEdit.IntCellEditSlider import IntCellEditSlider

from Britefury.SheetEdit.SheetEdit import BasicSingleFieldWidgetEditor



class IntFieldEditSlider (BasicSingleFieldWidgetEditor):
	__componentnames__ = [ 'slider' ]

	def __init__(self, field, minValue, maxValue, step, page):
		super( IntFieldEditSlider, self ).__init__( field )
	...
	def createElement(self, sheetEditContext):
		return IntCellEditSlider( self._minValue, self._maxValue, self._step, self._page )
...
if __name__ == '__main__':
	...
	class ExampleEditor (SheetEditor):
		...
		aEdit = IntFieldEditSlider( sheet.a, 0, 1024, 1, 10 )
