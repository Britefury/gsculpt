...
##-*************************
from Britefury.CellEdit.Vector2CellEditEntry import Vector2CellEditEntry

from Britefury.SheetEdit.SheetEdit import BasicSingleFieldWidgetEditor



class Vector2FieldEditEntry (BasicSingleFieldWidgetEditor):
	__componentnames__ = [ 'x', 'y' ]

	def __init__(self, field, minValue, maxValue, step, page, numDigits):
		super( Vector2FieldEditEntry, self ).__init__( field )
	...
	def createElement(self, sheetEditContext):
		return Vector2CellEditEntry( self._minValue, self._maxValue, self._step, self._page, self._numDigits )
...
if __name__ == '__main__':
	...
	class ExampleEditor (SheetEditor):
		...
		aEdit = Vector2FieldEditEntry( sheet.a, 0, 1024, 1, 10, 4 )
