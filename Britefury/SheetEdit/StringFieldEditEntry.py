...
##-*************************
from Britefury.CellEdit.StringCellEditEntry import StringCellEditEntry

from Britefury.SheetEdit.SheetEdit import BasicSingleFieldWidgetEditor



class StringFieldEditEntry (BasicSingleFieldWidgetEditor):
	__componentnames__ = [ 'entry' ]

	def createElement(self, sheetEditContext):
		return StringCellEditEntry()
...
if __name__ == '__main__':
	...
	class ExampleEditor (SheetEditor):
		...
		aEdit = StringFieldEditEntry( sheet.a )
