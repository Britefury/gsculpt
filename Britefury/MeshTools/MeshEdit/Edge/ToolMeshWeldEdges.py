...
class ProcMeshWeldEdges (GSProcedure):
	description = _( 'Weld edges' )
	...
	def procedureInvoke(self, inputObject, errorHandler):
		inputObject.weldMarkedEdges( self.blend.makePolyBlend(), self.style )
		return inputObject



class ToolMeshWeldEdges (GSProcedureTool):
	sheet = SheetRefField( ProcMeshWeldEdges )

	functionClass = ProcMeshWeldEdges
	pageTitle = _( 'Weld' )
	titleText = _( 'Weld Edges' )
