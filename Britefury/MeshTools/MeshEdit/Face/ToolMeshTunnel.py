...
class ProcMeshTunnel (GSProcedure):
	...
	def procedureInvoke(self, inputObject, errorHandler):
		inputObject.tunnel( self.blend.makePolyBlend(), self.segments )
		return inputObject



class ToolMeshTunnel (GSProcedureTool):
	sheet = SheetRefField( ProcMeshTunnel )

	functionClass = ProcMeshTunnel
	pageTitle = _( 'Tunnel' )
	titleText = _( 'Tunnel' )
