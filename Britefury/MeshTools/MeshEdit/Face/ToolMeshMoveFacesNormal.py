...
class ProcMeshMoveFacesNormal (GSProcedure):
	description = _( 'Move faces normal' )
	...
	def procedureInvoke(self, inputObject, errorHandler):
		...
		inputObject.moveFacesNormal( adjuster )
		adjuster.setParameters( self.distance )
		return inputObject



class MoveFacesNormalAdjustableInvoker (GSProcedureAdjustableInvoker):
	functionClass = ProcMeshMoveFacesNormal

	def main(self):
		self.mesh = deepcopy( self._inputObject )
		self.adjuster = MeshMoveNormalAdjuster()
		self.mesh.moveFacesNormal( self.adjuster )
...
class ToolMeshMoveFacesNormal (GSProcedureTool):
	sheet = SheetRefField( ProcMeshMoveFacesNormal )

	functionClass = ProcMeshMoveFacesNormal
	adjustableInvoker = MoveFacesNormalAdjustableInvoker
	pageTitle = _( 'Mv.Nml.' )
