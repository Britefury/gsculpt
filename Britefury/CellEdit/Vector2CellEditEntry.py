...
class Vector2CellEditEntry (Vector2OrPoint2CellEditEntry):
	"""Vector2 cell editor - entry
	@x - the x widget
	@y - the y widget"""

	__valueclass__ = Vector2
...
if __name__ == '__main__':
	...
	owner = CellOwner()
	cell1 = Vector2Cell( Vector2() )
	cell2 = Vector2Cell( Vector2() )
	cell1.owner = owner
	cell2.owner = owner
	owner.cellScope['Vector2'] = Vector2
	...
	entry1 = Vector2CellEditEntry( -1048576, 1048576, 1, 10, 4 )
	entry1.show()
	...
	entry2 = Vector2CellEditEntry( -1048576, 1048576, 1, 10, 4 )
	entry2.show()
