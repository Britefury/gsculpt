...
from Britefury.Transformation.Transformation import LinearTwistTransformation, MatrixTransformation
...
def makeTransformation(model, target, xformRotation, twist, lower, upper):
	...
	x1 = LinearTwistTransformation( d0, 0.0, d1, -math.radians( twist ), lower * 0.01, upper * 0.01 )
...
class ProcTransformationLinearTwist (ProcRotatedTransformation):
	description = _( 'Linear Twist' )
	...
	def procedureInvoke(self, inputObject, errorHandler):
		...
		ProcTransformationLinearTwist.transform( inputObject, x0, self.target )
		return inputObject




class TransformationLinearTwistAdjustableInvoker (RotatedTransformationAdjustableInvoker):
	functionClass = ProcTransformationLinearTwist
...
class ToolTransformationLinearTwist (ToolRotatedTransformation):
	sheet = SheetRefField( ProcTransformationLinearTwist )

	functionClass = ProcTransformationLinearTwist
	pageTitle = _( 'Linear Twist' )
	titleText = _( 'Linear Twist' )
	adjustableInvoker = TransformationLinearTwistAdjustableInvoker
